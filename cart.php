...
if(isset($_POST['update_cart'])){
    ...
    mysqli_query($conn,"UPDATE `cart` SET quantity = '$cart_quantity' WHERE id= '$card_id'") or die('query failed');
...
<section class="shopping-cart">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <img src="../BOOKSTORE/uploaded_img/<?php echo $fetch_cart['image']; ?>" alt="">
            ...
            <div class="sub_total"> sub total : <span>$<?php echo $sub_total = ($fetch_cart['quantity'] * $fetch_cart['price']); ?>/-</span> </div>
        </div>
        <?php
        $grand_total += $sub_total;
            }
